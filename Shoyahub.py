...
╚══════╝╚═╝  ╚═╝ ╚═════╝  ╚═════╝ ╚═╝  ╚═╝╚═╝  ╚═╝ ╚═════╝ ╚═════╝'''))
        ...
        print(f'''{Fore.LIGHTWHITE_EX}                                   Made by {Fore.YELLOW}0nlyshoya

{Fore.LIGHTWHITE_EX}GitHub: {Fore.LIGHTBLUE_EX}https://github.com/0nlySh0ya/Shoyahub
